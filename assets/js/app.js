...
jQuery(document).ready(function() {
	...
	//selectizer
	// $('.Projecte').selectize({
	// 	valueField: 'RefTreballFrm',
    //     labelField: 'RefTreballFrm',
    //     searchField: 'RefTreballFrm',
    //     load: function(query, callback) {
    //         if (query.length < 3){
    //             return callback();
    //         }else{
    //             $.ajax({
    //                 url: domain+'?view=hores&task=getRefsTreball&mode=raw',
    //                 type: 'GET',
    //                 dataType: 'json',
	// 				data: {
    //                     search: query,
	...
	$('.navTab').click(function(e) {
		...
		$('#'+view).load(domain+'?view=hores&layout='+view+'&mode=raw&userid='+userid+'&date='+date); 
	});
